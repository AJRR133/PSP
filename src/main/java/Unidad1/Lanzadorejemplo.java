...
public class Lanzadorejemplo {
	...
	private static final String rutaSource = "C:\\Users\\alumno\\Desktop\\sprint\\PSP\\src\\main\\java";
	...
	public void ejectaprocesojava() {
		String[] comando = {"java", "-cp", "target/classes/Unidad1", directorioGenerarClasses+"\\classes\\Unidad1\\Gestionaejemploo.class" };
		ProcessBuilder pb = new ProcessBuilder(comando);
